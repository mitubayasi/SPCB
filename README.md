...
本書では、どなたでも簡単に料理本が出版できるように、電子書籍での個人出版を目指します。電子書籍ならば、出版する際の費用は一切かからないので、リスクゼロでスタートできます。知識ゼロからでも必ず読み進められるので、本書を終える頃には、あなたオリジナルの料理本を必ず出版できるようになります(Windows, Mac両対応)。   
